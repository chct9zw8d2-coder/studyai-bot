...
PAYWALL_TEXT_VARIANTS = {
    ...
    "b": "🎓 С подпиской ты будешь учиться быстрее: больше решений, разборы, фото‑проверка .",
    "c": "⚡ Уже многие ученики учатся с StudyAI. Открой подписку, чтобы снять лимиты и получить полный доступ.",
}

WEEK_DEAL_VARIANTS = {
    "t250": {"stars": 249, "add_text": 250, "add_img": 0, "title": {"ru": "🔥 Пакет недели: +250 ответов", "en": "🔥 Weekly pack: +250 answers"}},
    "t350": {"stars": 199, "add_text": 350, "add_img": 0, "title": {"ru": "🔥 Пакет недели: +350 ответов", "en": "🔥 Weekly pack: +350 answers"}},
}
